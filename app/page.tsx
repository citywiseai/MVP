    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-800 via-slate-900 to-blue-900">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-4">
              ...
              <Link
                href="/signup"
                className="px-6 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-semibold transition-all duration-200 shadow-lg hover:shadow-xl"
              >
                Get Started
              </Link>
            </div>
      ...
      <section className="relative pt-32 pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto text-center animate-fade-in">
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight">
            Build Faster.
            <br />
            <span className="text-blue-400">Permit Smarter.</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/signup"
              className="inline-flex items-center justify-center px-8 py-4 bg-blue-600 hover:bg-blue-700 text-white text-lg font-semibold rounded-xl transition-all duration-200 shadow-xl hover:shadow-2xl hover:scale-105"
            >
              Get Started Free
            ...
            <Link
              href="/how-it-works"
              className="inline-flex items-center justify-center px-8 py-4 bg-white/10 backdrop-blur-sm hover:bg-white/20 text-white text-lg font-semibold rounded-xl transition-all duration-200 border border-white/20"
            >
              See How It Works
              <svg className="ml-2 w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-4" style={{textShadow: '0 0 20px rgba(255, 255, 255, 0.3), 0 0 10px rgba(255, 255, 255, 0.2)'}}>
              Everything You Need
            </h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {/* Feature 1 */}
            <div className="bg-white rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 group">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-3">Zoning Analysis</h3>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 group">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-3">Smart Requirements</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 group">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-3">Permit Tracking</h3>
              <p className="text-gray-600">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8 text-center">
            <div className="animate-slide-up">
              ...
              <div className="text-white/70 font-medium">Faster Planning</div>
            </div>
            <div className="animate-slide-up delay-100">
              <div className="text-5xl font-bold text-white mb-2">90%</div>
              <div className="text-white/70 font-medium">Time Saved</div>
            </div>
            <div className="animate-slide-up delay-200">
              <div className="text-5xl font-bold text-blue-400 mb-2">AI-Powered</div>
              <div className="text-white/70 font-medium">Smart Analysis</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        <div className="absolute inset-0">
          <div className="absolute top-0 left-0 w-full h-full opacity-10">
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-blue-400 rounded-full filter blur-3xl animate-pulse" />
          </div>
        </div>
      ...
      <footer className="py-8 px-4 sm:px-6 lg:px-8 bg-black/20 backdrop-blur-sm border-t border-white/10">
        <div className="max-w-7xl mx-auto text-center">
          <p className="text-white/70 text-sm flex items-center justify-center gap-3 flex-wrap">
