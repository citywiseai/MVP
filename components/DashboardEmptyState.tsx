      ...
      <div className="max-w-6xl mx-auto px-6 py-12 text-center">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          <button
            ...
            className="group relative overflow-hidden rounded-2xl p-8 text-left transition-all duration-300 hover:scale-105 hover:shadow-2xl bg-gradient-to-br from-[#d4836f] to-[#c86f4d] flex flex-col"
          >
            <div className="relative z-10 flex-1 flex flex-col">
              ...
              <h3 className="text-xl font-bold text-white mb-3 h-14 flex items-center leading-tight">
                Create Your First Project
              </h3>
              
              <p className="text-white/90 text-sm leading-relaxed mb-6 h-20 flex items-start">
                Scout will ask a few questions about your property and project scope to get started.
              </p>
              
              <div className="mt-auto inline-flex items-center text-sm font-medium text-white">
                Get Started
          ...
          <button
            ...
            className="group relative overflow-hidden rounded-2xl p-8 text-left transition-all duration-300 hover:scale-105 hover:shadow-xl bg-gradient-to-br from-[#9caf88] to-[#8a9d78] cursor-pointer flex flex-col"
          >
            <div className="relative z-10 flex-1 flex flex-col">
              <div className="w-12 h-12 rounded-xl bg-white/20 backdrop-blur-sm flex items-center justify-center mb-4 group-hover:bg-white/30 transition-colors">
          ...
          <button
            ...
            className="group relative overflow-hidden rounded-2xl p-8 text-left transition-all duration-300 hover:scale-105 hover:shadow-xl bg-gradient-to-br from-[#1e3a5f] to-[#2c4f6f] cursor-pointer flex flex-col"
          >
            <div className="relative z-10 flex-1 flex flex-col">
              <div className="w-12 h-12 rounded-xl bg-white/20 backdrop-blur-sm flex items-center justify-center mb-4 group-hover:bg-white/30 transition-colors">
