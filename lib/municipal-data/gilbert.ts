// lib/municipal-data/gilbert.ts
// Gilbert, AZ Municipal Zoning Database

import type { ZoningDistrict } from './phoenix';

export const gilbertZoning: Record<string, ZoningDistrict> = {
  ...
  "SF-43": {
    ...
    adu: {
      ...
      parking: 1,
      requiresOwnerOccupancy: true, // Gilbert requires owner-occupancy
      maxHeight: 25,
      notes: [
        "Gilbert requires owner-occupancy for ADU or primary dwelling",
        "Called 'Accessory Dwelling Unit' in Gilbert code",
      ],
    },
    pool: {
  ...
  "SF-7": {
    ...
    adu: {
      ...
      notes: ["Lot too small for ADU (8,000 sf minimum in Gilbert)"],
    },
    pool: {
      setbackFromProperty: 5,
      setbackFromHouse: 5,
...
export function getZoningByCode(code: string): ZoningDistrict | null {
  ...
  return gilbertZoning[normalizedCode] || null;
}

export default gilbertZoning;
