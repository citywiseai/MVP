// lib/municipal-data/payson.ts
// Payson, AZ Municipal Zoning Database
// Note: Rim Country, gateway to Mogollon Rim

import type { ZoningDistrict } from './phoenix';

export const paysonZoning: Record<string, ZoningDistrict> = {
  ...
  "R1-43": {
    ...
    adu: {
      ...
      maxHeight: 25,
      notes: ["Payson - Rim Country", "Gateway to Mogollon Rim"],
    },
...
export function getZoningByCode(code: string): ZoningDistrict | null {
  ...
  return paysonZoning[normalizedCode] || null;
}

export default paysonZoning;
