// lib/municipal-data/avondale.ts
// Avondale, AZ Municipal Zoning Database

import type { ZoningDistrict } from './phoenix';

export const avondaleZoning: Record<string, ZoningDistrict> = {
  ...
  "R1-35": {
    ...
    setbacks: { front: 30, rear: 30, side: 15, streetSide: 20 },
    adu: {
      allowed: true,
      maxSizeSqFt: 1000,
      minLotSizeSqFt: 6000,
...
export function getZoningByCode(code: string): ZoningDistrict | null {
  ...
  return avondaleZoning[normalizedCode] || null;
}

export default avondaleZoning;
