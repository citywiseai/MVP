// lib/municipal-data/queen-creek.ts
// Queen Creek, AZ Municipal Zoning Database
// Note: Spans Maricopa/Pinal counties, fast-growing suburban community

import type { ZoningDistrict } from './phoenix';

export const queenCreekZoning: Record<string, ZoningDistrict> = {
  ...
  "R1-43": {
    ...
    adu: {
      ...
      maxHeight: 25,
      notes: ["Queen Creek - spans Maricopa/Pinal counties, fast-growing"],
    },
...
export function getZoningByCode(code: string): ZoningDistrict | null {
  ...
  return queenCreekZoning[normalizedCode] || null;
}

export default queenCreekZoning;
