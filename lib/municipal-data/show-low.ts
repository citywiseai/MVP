// lib/municipal-data/show-low.ts
// Show Low, AZ Municipal Zoning Database
// Note: White Mountains gateway, cool summer climate

import type { ZoningDistrict } from './phoenix';

export const showLowZoning: Record<string, ZoningDistrict> = {
  ...
  "R1-43": {
    ...
    adu: {
      ...
      maxHeight: 25,
      notes: ["Show Low - White Mountains gateway", "Cool summer climate, popular retirement"],
    },
...
export function getZoningByCode(code: string): ZoningDistrict | null {
  ...
  return showLowZoning[normalizedCode] || null;
}

export default showLowZoning;
