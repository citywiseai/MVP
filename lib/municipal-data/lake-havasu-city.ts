// lib/municipal-data/lake-havasu-city.ts
// Lake Havasu City, AZ Municipal Zoning Database
// Note: London Bridge, Colorado River recreation

import type { ZoningDistrict } from './phoenix';

export const lakeHavasuCityZoning: Record<string, ZoningDistrict> = {
  ...
  "R1-43": {
    ...
    adu: {
      ...
      maxHeight: 25,
      notes: ["Lake Havasu City - home of London Bridge", "Colorado River recreation destination"],
    },
...
export function getZoningByCode(code: string): ZoningDistrict | null {
  ...
  return lakeHavasuCityZoning[normalizedCode] || null;
}

export default lakeHavasuCityZoning;
