// lib/municipal-data/glendale.ts
// Glendale, AZ Municipal Zoning Database

import type { ZoningDistrict } from './phoenix';

export const glendaleZoning: Record<string, ZoningDistrict> = {
  ...
  "R1-43": {
    ...
    adu: {
      ...
      maxHeight: 25,
      notes: ["Glendale allows ADUs in all single-family zones"],
    },
...
export function getZoningByCode(code: string): ZoningDistrict | null {
  ...
  return glendaleZoning[normalizedCode] || null;
}

export default glendaleZoning;
