// lib/municipal-data/eloy.ts
// Eloy, AZ Municipal Zoning Database
// Note: Skydiving capital, agricultural community

import type { ZoningDistrict } from './phoenix';

export const eloyZoning: Record<string, ZoningDistrict> = {
  ...
  "R1-43": {
    ...
    adu: {
      ...
      maxHeight: 25,
      notes: ["Eloy - skydiving capital of the Southwest", "Agricultural community"],
    },
  ...
  "R1-6": {
    ...
    adu: {
      ...
      parking: 0,
      requiresOwnerOccupancy: false,
      notes: ["Lot too small for ADU (8,000 sf minimum in Eloy)"],
    },
    pool: { setbackFromProperty: 5, setbackFromHouse: 5, requiresFence: true, fenceHeight: 5, permitRequired: true },
...
export function getZoningByCode(code: string): ZoningDistrict | null {
  ...
  return eloyZoning[normalizedCode] || null;
}

export default eloyZoning;
