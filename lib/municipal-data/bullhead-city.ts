// lib/municipal-data/bullhead-city.ts
// Bullhead City, AZ Municipal Zoning Database
// Note: Colorado River city, across from Laughlin NV

import type { ZoningDistrict } from './phoenix';

export const bullheadCityZoning: Record<string, ZoningDistrict> = {
  ...
  "R1-35": {
    ...
    adu: {
      ...
      maxHeight: 25,
      notes: ["Bullhead City - Colorado River recreation", "Across from Laughlin, Nevada"],
    },
...
export function getZoningByCode(code: string): ZoningDistrict | null {
  ...
  return bullheadCityZoning[normalizedCode] || null;
}

export default bullheadCityZoning;
