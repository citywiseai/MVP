// lib/municipal-data/tolleson.ts
// Tolleson, AZ Municipal Zoning Database

import type { ZoningDistrict } from './phoenix';

export const tollesonZoning: Record<string, ZoningDistrict> = {
...
export function getZoningByCode(code: string): ZoningDistrict | null {
  ...
  return tollesonZoning[normalizedCode] || null;
}

export default tollesonZoning;
