// lib/municipal-data/yuma.ts
// Yuma, AZ Municipal Zoning Database
// Note: Sunniest city on Earth, agricultural hub, military base

import type { ZoningDistrict } from './phoenix';

export const yumaZoning: Record<string, ZoningDistrict> = {
  ...
  "R-1": {
    ...
    adu: {
      ...
      maxHeight: 25,
      notes: ["Yuma - sunniest city on Earth", "Agricultural hub, MCAS Yuma"],
    },
...
export function getZoningByCode(code: string): ZoningDistrict | null {
  ...
  return yumaZoning[normalizedCode] || null;
}

export default yumaZoning;
