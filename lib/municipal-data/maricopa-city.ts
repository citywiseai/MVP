// lib/municipal-data/maricopa-city.ts
// City of Maricopa, AZ Municipal Zoning Database
// Note: Fast-growing city in Pinal County, master-planned communities

import type { ZoningDistrict } from './phoenix';

export const maricopaCityZoning: Record<string, ZoningDistrict> = {
  ...
  "R1-43": {
    ...
    adu: {
      ...
      maxHeight: 25,
      notes: ["City of Maricopa - one of fastest growing cities in US", "Many master-planned communities"],
    },
...
export function getZoningByCode(code: string): ZoningDistrict | null {
  ...
  return maricopaCityZoning[normalizedCode] || null;
}

export default maricopaCityZoning;
