// lib/municipal-data/sahuarita.ts
// Sahuarita, AZ Municipal Zoning Database
// Note: Growing south Tucson suburb, master-planned communities

import type { ZoningDistrict } from './phoenix';

export const sahuaritaZoning: Record<string, ZoningDistrict> = {
  ...
  "R1-43": {
    ...
    adu: {
      ...
      maxHeight: 25,
      notes: ["Sahuarita - growing south Tucson suburb", "Master-planned communities"],
    },
...
export function getZoningByCode(code: string): ZoningDistrict | null {
  ...
  return sahuaritaZoning[normalizedCode] || null;
}

export default sahuaritaZoning;
