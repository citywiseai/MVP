// lib/municipal-data/goodyear.ts
// Goodyear, AZ Municipal Zoning Database

import type { ZoningDistrict } from './phoenix';

export const goodyearZoning: Record<string, ZoningDistrict> = {
  ...
  "R1-35": {
    ...
    adu: {
      ...
      maxHeight: 25,
      notes: ["Goodyear - rapidly growing West Valley city"],
    },
...
export function getZoningByCode(code: string): ZoningDistrict | null {
  ...
  return goodyearZoning[normalizedCode] || null;
}

export default goodyearZoning;
