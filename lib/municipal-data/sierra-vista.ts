// lib/municipal-data/sierra-vista.ts
// Sierra Vista, AZ Municipal Zoning Database
// Note: Fort Huachuca, birding capital of the US

import type { ZoningDistrict } from './phoenix';

export const sierraVistaZoning: Record<string, ZoningDistrict> = {
  ...
  "R1-43": {
    ...
    adu: {
      ...
      maxHeight: 25,
      notes: ["Sierra Vista - home of Fort Huachuca", "Birding capital of the US"],
    },
...
export function getZoningByCode(code: string): ZoningDistrict | null {
  ...
  return sierraVistaZoning[normalizedCode] || null;
}

export default sierraVistaZoning;
